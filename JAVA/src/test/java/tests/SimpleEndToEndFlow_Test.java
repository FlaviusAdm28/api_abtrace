package tests;
import com.abtrace.api.builders.BuilderCSV;
import com.abtrace.api.builders.JsonParser;
import com.abtrace.api.enumeration.*;
...
public class SimpleEndToEndFlow_Test {

    private String jsonBody;
    private String lastCreatedTitle;
    private final Logger logger = Logger.getLogger(SimpleEndToEndFlow_Test.class);
    ...
    public void POST_ITEM() throws IOException, ParseException {
        ...
        Assert.assertEquals(response.getStatusCode(), StatusCodeEnum.STATUS_200.getCode());
    }
